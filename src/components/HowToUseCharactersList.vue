<template>
    <label for="howtouse_characters" class="btn btn-primary btn-sm">
    ...
    <div class="modal">
        <div class="modal-box border">
            <label for="howtouse_characters" class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2 z-30">✕</label>
